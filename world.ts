...
export const worlds = [
  new World(
    ...
    (w) => {
      ...
      w.add(
        ...
        .add(new ParamSphere().translate(-2, 1, 4).commit())
        .add(
          new ParamSphere()
            .translate(-2, 0, -4)
        ...
        .add(
          new Cylinder(20)
            ...
            .setSpecular(Color.RED)
            .translate(2, 0, -2)
        )
        .add(
          new Cylinder(20)
            .setColor(new Color(0.6, 0.7, 1))
            .setSpecular(Color.BLUE)
            .translate(2, 0, -4)
        )
        .add(
          new Tetrahedron()
  ...
  new World(
    ...
    (w) => {
      ...
      w.add(new ParamSphere("sphere 1").setTranslate(0.8, 0, 0)).add(
        new ParamSphere("sphere 2").setTranslate(-0.8, 0, 0)
      );
    }
  ),
  new World(
    "Lots of Sphere",
    new Camera({ ratio: 12 / 8, eye: [-10, 1, -10], at: [0, 5, -2] }),
    (w) => {
      w.baseMaterial = new Material()
        .setColor(Color.GRAY)
        .setSpecular(Color.BLACK)
      ...
      for (let i = -5; i < 5; i++) {
        for (let j = -5; j < 5; j++) {
          w.add(new ParamSphere().translate(i * 1.5, 0, j * 1.5));
        }
      }
    }
  ),
  new World(
    ...
    (w) => {
      ...
      w.add(buildATAT().translate(0, 6.7, 0));
    }
  ),
];
